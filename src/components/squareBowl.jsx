...
import img1 from './bowls-image/square-bowl/img1.jpg'
import img2 from './bowls-image/square-bowl/img2.jpg'
import img3 from './bowls-image/square-bowl/img3.jpg'
import bannerImg from './itemsImage/round-plates/areca-nut-leaf-plates-in-bangalore-india.jpg'
import { Link } from 'react-router-dom';

import LeftNav from './leftNav'
function SquareBowl(props) {
    const myRef = useRef();

    function scrollToComponent() {
      if (window.location.hash === '#square-bowl') {
